...
const ColorScheme = () => {
  ...
  return <Fragment>
            ...
            <Row>
                {modes.map((item, idx) => <Col xs={4} key={item.mode + idx}>
                            <div className="form-check card-radio">
                                <input className="form-check-input" type="radio" name="data-bs-theme" id={`layout-color-${item.mode}`} onChange={() => changeTheme(item.mode)} checked={item.mode === theme} />
                                <label className="form-check-label p-3 w-100 d-flex justify-content-center align-items-center" htmlFor={`layout-color-${item.mode}`}>
                                    ...
                                    {item.mode === theme && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
...
const OrientationScheme = () => {
  ...
  return <>
            ...
            <Row>
                {modes.map((item, idx) => <Col xs={4} key={item.mode + idx}>
                            <div className="form-check card-radio">
                                <input className="form-check-input" type="radio" name="data-layout" id={`layout-type-${item.mode}`} onChange={() => changeLayoutOrientation(item.mode)} checked={orientation === item.mode} />
                                <label className="form-check-label p-3 w-100 d-flex justify-content-center align-items-center" htmlFor={`layout-type-${item.mode}`}>
                                    <div className='check-icon'>
                                        {orientation === item.mode && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <IconifyIcon icon={item.icon} className="fs-32 text-muted" />
                                </label>
                            </div>
...
const LayoutMode = () => {
  ...
  return <>
            ...
            <Row>
                <Col xs={4}>
                    <div className="form-check card-radio">
                        <input className="form-check-input" type="radio" name="data-layout-mode" id="layout-mode-fluid" onChange={() => changeLayoutMode('fluid')} checked={mode === 'fluid'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor={`layout-mode-fluid`}>
                            {mode === 'fluid' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                            <div>
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-layout-mode" id="data-layout-detached" onChange={() => changeLayoutMode('detached')} checked={mode === 'detached'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="data-layout-detached">
                            {/* <div className='check-icon'> */}
                            {mode === 'detached' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                            {/* </div> */}
                            <span className="d-flex h-100 flex-column">
...
const TopbarTheme = () => {
  ...
  return <>
            ...
            <Row>
                {modes.map((mode, idx) => <Col xs={3} key={idx}>
                            <div className="form-check card-radio">
                                <input className="form-check-input" type="radio" name="data-topbar-color" id={`topbar-color-${mode}`} onChange={() => changeTopColor(mode)} checked={topBar.color === mode} />
                                <label className="form-check-label p-0 avatar-lg w-100 bg-light" htmlFor={`topbar-color-${mode}`}>
                                    <div className='check-icon'>
                                        {topBar.color === mode && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
...
const MenuTheme = () => {
  ...
  return <>
            ...
            <Row>
                {modes.map((mode, idx) => <Col xs={3} key={idx}>
                            <div className="form-check sidebar-setting card-radio">
                                <input className="form-check-input" type="radio" name="data-menu-color" id={`sidenav-color-${mode}`} onChange={() => changeMainMenuColor(mode)} checked={mainMenu.color === mode} />
                                <label className="form-check-label p-0 avatar-lg w-100 bg-light" htmlFor={`sidenav-color-${mode}`}>
                                    <div className='check-icon'>
                                        {mainMenu.color === mode && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <span className="d-flex align-items-center justify-content-center h-100">
                                        <span className={`p-2 d-inline-flex shadow rounded-circle bg-${mode == 'brand' ? 'primary' : mode == 'light' ? 'white' : 'dark'}`} />
                                    </span>
...
const SidebarSize = () => {
  ...
  return <>
            ...
            <Row>
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id={`sidenav-size-${'default'}`} onChange={() => changeMainMenuSize('default')} checked={mainMenu.size === 'default'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-default">
                            <span className="d-flex h-100">
                                ...
                                <span className="flex-grow-1">
                                    <div className='check-icon'>
                                        {mainMenu.size === 'default' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <span className="d-flex h-100 flex-column">
                                        <span className="bg-light d-block p-1" />
                                    </span>
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-compact" onChange={() => changeMainMenuSize('compact')} checked={mainMenu.size === 'compact'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-compact">
                            <span className="d-flex h-100">
                                ...
                                <span className="flex-grow-1">
                                    <div className='check-icon'>
                                        {mainMenu.size === 'compact' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <span className="d-flex h-100 flex-column">
                                        <span className="bg-light d-block p-1" />
                                    </span>
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-small" onChange={() => changeMainMenuSize('condensed')} checked={mainMenu.size === 'condensed'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-small">
                            <span className="d-flex h-100">
                                <span className="flex-shrink-0">
                                    <span className="bg-light d-flex h-100 border-end flex-column" style={{
                  padding: 2
                }}>
                                        <span className="d-block p-1 bg-dark-subtle rounded mb-1" />
                                        <span className="d-block border border-3 border-secondary border-opacity-25 rounded w-100 mb-1" />
                                ...
                                <span className="flex-grow-1">
                                    <div className='check-icon'>
                                        {mainMenu.size === 'condensed' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <span className="d-flex h-100 flex-column">
                                        <span className="bg-light d-block p-1" />
                                    </span>
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-small-hover" onChange={() => changeMainMenuSize('sm-hover')} checked={mainMenu.size === 'sm-hover'} />
                  ...
                  padding: 2
                                ...
                                <span className="flex-grow-1">
                                    <div className='check-icon'>
                                        {mainMenu.size === 'sm-hover' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                                    </div>
                                    <span className="d-flex h-100 flex-column">
                                        <span className="bg-light d-block p-1" />
                                    </span>
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-full" onChange={() => changeMainMenuSize('full')} checked={mainMenu.size === 'full'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-full">
                            <div className='check-icon'>
                                {mainMenu.size === 'full' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                            </div>
                            <span className="d-flex h-100">
                                <span className="flex-shrink-0">
                                    <span className="d-flex h-100 flex-column">
                ...
                <Col xs={4}>
                    <div className="form-check sidebar-setting card-radio">
                        <input className="form-check-input" type="radio" name="data-sidenav-size" id="sidenav-size-fullscreen" defaultValue="fullscreen" onChange={() => changeMainMenuSize('fullscreen')} checked={mainMenu.size === 'fullscreen'} />
                        <label className="form-check-label p-0 avatar-xl w-100" htmlFor="sidenav-size-fullscreen">
                            <div className='check-icon'>
                                {mainMenu.size === 'fullscreen' && <IconifyIcon icon="tabler:circle-check-filled" className='check-icons' />}
                            </div>
                            <span className="d-flex h-100">
                                <span className="flex-grow-1">
                                    <span className="d-flex h-100 flex-column">
