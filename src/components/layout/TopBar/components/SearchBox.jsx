...
const SearchBox = () => {
  ...
  return <>
      <div onClick={toggle} className="topbar-search text-muted d-none d-xl-flex gap-2 me-2 align-items-center" data-bs-toggle="modal" data-bs-target="#searchModal">
            ...
            <form>
              <Card className="mb-0">
                <div className="px-3 py-2 d-flex flex-row align-items-center" id="top-search">
                  ...
                  <a onClick={toggle} className="btn p-0" data-bs-dismiss="modal" aria-label="Close">[esc]</a>
                </div>
              </Card>
            </form>
        </ModalDialog>
