...
const SolarIconsCard = ({
  ...
  return <OverlayTrigger placement="top" overlay={<Tooltip>{title}</Tooltip>}>
      <Card className='mb-0'>
...
const SolarIcon = () => {
  return <>
      ...
      <div className="my-3 text-center">
        <Link to="https://icon-sets.iconify.design/solar/" target="_blank" className="btn btn-danger">View All Icons</Link>
      </div>
    </>;
};
