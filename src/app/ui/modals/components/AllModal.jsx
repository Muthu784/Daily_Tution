...
const BootstrapModals = () => {
  ...
  return <ComponentContainerCard title="Bootstrap Modals" description={<>A rendered modal with header, body, and set of actions in the footer.</>}>
...
const ModalsWithPages = () => {
  ...
  return <ComponentContainerCard title="Modal with Pages" description={<>Examples of custom modals.</>}>
      <div className="d-flex flex-wrap gap-2">
...
const ModalWithAlerts = () => {
  ...
  return <ComponentContainerCard title="Modal based Alerts" description={<>Show different contexual alert messages using modal component</>}>
      <div className="d-flex flex-wrap gap-2">
...
const ModalPositions = () => {
  ...
  return <ComponentContainerCard title="Modal Position" description={<>
...
const ModalWithColoredHeader = () => {
  ...
  return <ComponentContainerCard title="Colored Header Modals" description={<>A rendered modal with header having contexual background color.</>}>
...
const ModalWithFilled = () => {
  ...
  return <ComponentContainerCard title="Filled Modals" description={<>A rendered modal with header, body and footer having contexual background color.</>}>
...
const MultipleModal = () => {
  ...
  return <ComponentContainerCard title="Multiple Modal" description={<>Display a series of modals one by one to guide your users on multiple aspects or take step wise input.</>}>
...
const ToggleBetweenModals = () => {
  ...
  return <ComponentContainerCard title="Toggle Between Modals" description={<>
...
const FullscreenModal = () => {
  ...
  return <ComponentContainerCard title="Fullscreen Modal" description={<>
...
const StaticBackdropModal = () => {
  ...
  return <ComponentContainerCard title="Static Backdrop" description={<>
...
const VaryingModalContent = () => {
  ...
  return <ComponentContainerCard title="Varying Modal Content" description={<>
