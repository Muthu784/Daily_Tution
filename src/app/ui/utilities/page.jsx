...
const BackgroundColor = () => {
  return <ComponentContainerCard title='Background Color' description={<>Similar to the contextual text color classes, set the background
...
const BackgroundGradientColor = () => {
  return <ComponentContainerCard title='Background Gradient Color' description={<>By adding a <code>.bg-gradient</code> class, a linear gradient is
...
const SoftBackground = () => {
  return <ComponentContainerCard title='Soft Background' description={<>Similar to the contextual text color classes, set the background
...
const BackgroundAndColor = () => {
  return <ComponentContainerCard title='Color &amp; Background' description={<>Color and background helpers combine the power of our
...
const ColoredLinks = () => {
  return <ComponentContainerCard title='Colored links' description={<>You can use the <code>.link-*</code> classes to colorize
      links. Unlike the <code>.text-*</code> classes, these classes have a
      <code>:hover</code> and <code>:focus</code> state.</>}>
      <div className="d-flex flex-column gap-2">
        <Link to="" className="link-primary">Primary link</Link>
        <Link to="" className="link-secondary">Secondary link</Link>
        <Link to="" className="link-success">Success link</Link>
        <Link to="" className="link-danger">Danger link</Link>
        <Link to="" className="link-warning">Warning link</Link>
        <Link to="" className="link-info">Info link</Link>
        <Link to="" className="link-light">Light link</Link>
        <Link to="" className="link-dark">Dark link</Link>
      </div>
    </ComponentContainerCard>;
};
const BackgroundOpacity = () => {
  return <ComponentContainerCard title='Background Opacity' description={<><code>background-color</code> utilities are generated with Sass
...
const TextColor = () => {
  return <ComponentContainerCard title='Text Color' description={<>Colorize text with color utilities. If you want to colorize links,
...
const TextOpacityColor = () => {
  return <ComponentContainerCard title='Text Opacity Color' description={<>text color utilities are generated with Sass using CSS variables.
...
const Opacity = () => {
  return <ComponentContainerCard title='Opacity' description={<>The <code>opacity</code> property sets the opacity level for an
...
const AdditiveBorder = () => {
  return <ComponentContainerCard title='Additive(Add) Border' description={<>Use border utilities to <b>add</b> an element’s borders. Choose
...
const SubtractiveBorder = () => {
  return <ComponentContainerCard title='Subtractive(Remove) Border' description={<>Use border utilities to <b>remove</b> an element’s borders. Choose
      from all borders or one at a time.</>}>
      <div className="d-flex align-items-start flex-wrap gap-4">
        <div className="text-center">
...
const BorderColor = () => {
  return <ComponentContainerCard title='Border Color' description={<>Change the border color using utilities built on our theme colors.</>}>
...
const BorderWidthSize = () => {
  return <ComponentContainerCard title='Border Width Size' description={<></>}>
      <div className="d-flex align-items-start flex-wrap gap-2">
        <div className="text-center">
...
const BorderOpacity = () => {
  return <ComponentContainerCard title='Border Opacity' description={<>choose from any of the <code>.border-opacity</code> utilities:</>}>
...
const BorderSubtleColor = () => {
  return <ComponentContainerCard title='Border Subtle Color' description={<>Change the border color using utilities built on our theme colors.</>}>
      <div className="d-flex align-items-start flex-wrap gap-2">
        <div className="text-center">
...
const BorderRadius = () => {
  return <ComponentContainerCard title='Border Radius' description={<>Add classes to an element to easily round its corners.</>}>
      <div className="d-flex align-items-start flex-wrap gap-2">
...
const BorderRadiusSize = () => {
  return <ComponentContainerCard title='Border Radius Size' description={<>Use the scaling classes for larger or smaller rounded corners.
...
const TextSelection = () => {
  return <ComponentContainerCard title='Text Selection' description={<>Use <code>user-select-all</code>, <code>user-select-auto</code>,
      or
...
const PointerEvents = () => {
  return <ComponentContainerCard title='Pointer Events' description={<>Bootstrap provides <code>.pe-none</code> and <code>.pe-auto</code>
      classes to prevent or add element interactions.</>}>
      <p><Link to="" className="pe-none" tabIndex={-1} aria-disabled="true">This link</Link>
        can not be clicked.</p>
      <p><Link to="" className="pe-auto">This link</Link> can be clicked (this is default
        behavior).</p>
      <p className="pe-none"><Link to="" tabIndex={-1} aria-disabled="true">This link</Link>
        can not be clicked because the
        <code>pointer-events</code> property is inherited from its parent. However,
        <Link to="" className="pe-auto">this
          link</Link> has a <code>pe-auto</code> class and can be clicked.
      </p>
    </ComponentContainerCard>;
};
const Overflow = () => {
  return <ComponentContainerCard title='Overflow' description={<>Adjust the <code>overflow</code> property on the fly with four
...
const PositionInArrange = () => {
  return <ComponentContainerCard title='Position in Arrange' description={<>Arrange elements easily with the edge positioning utilities. The
...
const PositionCenter = () => {
  return <ComponentContainerCard title='Position in Center' description={<>In addition, you can also center the elements with the transform
...
const PositionAxis = () => {
  return <ComponentContainerCard title='Position in Axis' description={<>By adding <code>.translate-middle-x</code> or
...
const Shadows = () => {
  return <ComponentContainerCard title='Shadows' description={<>While shadows on components are disabled by default in Bootstrap
...
const Width = () => {
  return <ComponentContainerCard title='Width' description={<>Width utilities are generated from the utility API in
...
const Height = () => {
  return <ComponentContainerCard title='Height' description={<>Height utilities are generated from the utility API in
      <code>_utilities.scss</code>. Includes support for
      <code>25%</code>, <code>50%</code>, <code>75%</code>, <code>100%</code>, and
      <code>auto</code> by default. Modify
      those values as you need to generate different utilities here.</>}>
...
const ObjectFit = () => {
  return <ComponentContainerCard title='Object Fit' description={<>Change the value of the <a href="https://developer.mozilla.org/en-US/docs/Web/CSS/object-fit"><code>object-fit</code>
...
const ZIndex = () => {
  return <ComponentContainerCard title='Z-index' description={<>Use <code>z-index</code> utilities to stack elements on top of one
      another. Requires a <code>position</code> value other than <code>static</code>,
      which can be set with custom styles or using our <Link to="/docs/5.3/utilities/position/">position utilities</Link>.</>}>
...
const Utilities = () => {
  return <>
      <PageBreadcrumb title='Utilities' />
      <Row>
        <Col xl={6}>
          <BackgroundColor />
        </Col>
