        ...
        <Row className="g-0 justify-content-center w-100 m-xxl-5 px-xxl-4 m-3">
          <Col xxl={3} lg={5} md={6}>
            <Link to="/" className="auth-brand d-flex justify-content-center mb-2">
              <img src={logoDark} alt="dark logo" height={50} className="logo-dark" />
              <img src={logo} alt="logo light" height={50} className="logo-light" />
            </Link>
            ...
            <Card className="overflow-hidden text-center p-xxl-4 p-3 mb-0">
              ...
              <p className="text-muted fs-14 mb-0">
                Not you? return <Link to="/auth/login" className="fw-semibold text-danger ms-1">Login !</Link>
              </p>
            </Card>
