...
const Error401Page = () => {
  return <>
    <PageBreadcrumb title='Error 401' />
        ...
        <Col xxl={3} lg={5} md={6}>
          ...
          <Card className="overflow-hidden text-center p-xxl-4 p-3 mb-0">
            <div className="text-center">
              ...
              <h3 className="mt-3 mb-2">Error Unauthorized !</h3>
              <p className="text-muted mb-3">Sorry, but you are not authorized to view this page.</p>
