  ...
  return <Card>
      <Card.Body>
        ...
        overflow: 'hidden'
          ...
          onLoad={onLoad} onUnmount={onUnmount}></GoogleMap>
          </LoadScript>
        </div>
      </Card.Body>
    </Card>;
  ...
  return <Card>
      <Card.Body>
        ...
        overflow: 'hidden'
          ...
          <LoadScript googleMapsApiKey="AIzaSyAgIfLQi8KTxTJahilcem6qHusV-V6XXjw">
            <GoogleMap mapContainerStyle={containerStyle} center={center} zoom={14} mapTypeId="hybrid" // Change this to "roadmap", "satellite", "terrain", etc.
          onLoad={onLoad} onUnmount={onUnmount}></GoogleMap>
      ...
      <Card.Body>
        ...
        overflow: 'hidden'
          ...
          <LoadScript googleMapsApiKey="AIzaSyAgIfLQi8KTxTJahilcem6qHusV-V6XXjw">
            ...
            styles: mapStyles
          }} zoom={14} onLoad={onLoad} onUnmount={onUnmount}></GoogleMap>
          </LoadScript>
        </div>
      </Card.Body>
    </Card>;
