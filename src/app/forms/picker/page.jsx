                ...
                <Row className="gy-3">
                  <Col lg={6}>
                    <div>
                      ...
                      <CustomFlatpickr className="form-control" options={{
                      enableTime: false
                    }} />
                    </div>
                  </Col>
                ...
                <Row>
                  <Col lg={6}>
                    <div className="mt-3">
                      ...
                      <CustomFlatpickr placeholder='25 jan, 2024' className="form-control" options={{
                      dateFormat: 'd M, Y',
                      enableTime: false
                    }} />
                    </div>
                ...
                <Row>
                  ...
                  <Col lg={6}>
                    <div className="mt-3">
                      ...
                      <CustomFlatpickr className="form-control" placeholder="16:45" options={{
                      noCalendar: true,
                      enableTime: true,
                      dateFormat: 'H:i',
                      defaultDate: '13:45'
