...
import { Button, Card, CardBody, CardFooter, CardHeader, Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Pagination, Table } from "react-bootstrap";
      ...
      <CardBody className="p-0">
        ...
        <div className="table-responsive">
          <Table className="table-custom table-centered table-sm table-nowrap table-hover mb-0">
            <tbody>
              {brandListData.map((item, idx) => <tr key={idx}>
                    <td>
                    ...
                    <td>
                      ...
                      <h5 className="fs-14 mt-1 fw-normal"><IconifyIcon icon='tabler:circle-filled' className="fs-12 text-success" /> Active</h5>
                    </td>
                    <td style={{
                width: 30
              }}>
