...
const ComposeEmailModal = ({
  ...
  return <>
              ...
              <Card className="mb-1 shadow-none border border-light">
                <div className="p-2">
                  <Row className="align-items-center">
                    ...
                    <Col className="ps-0">
                      <Link to="" className="text-muted fw-bold">Osen-admin-design.zip</Link>
      ...
      <Modal size='lg' show={isOpen} onHide={toggleComposeModal} id="email-compose-modal" className="modal-dialog-centered fade" tabIndex={-1} role="dialog" aria-labelledby="email-compose-modalLabel" aria-hidden="true">
        ...
        <ModalBody>
          <form>
            ...
            <div>
              ...
              <ReactQuill className='mb-4' theme="snow" value={quillEditorContent} onChange={setQuillEditorContent} style={{
              height: 150
            }} />
            </div>
          </form>
      ...
      {/* <Modal show={isOpen} onHide={toggleComposeModal} id="email-compose-modal" className="fade" tabIndex={-1} role="dialog" aria-labelledby="email-compose-modalLabel" aria-hidden="true">
        <ModalDialog className="modal-dialog-centered modal-lg">
          <ModalHeader className="py-2">
            <ModalTitle as={'h4'} className="modal-title" id="email-compose-modalLabel">New Message</ModalTitle>
            <button type="button" className="btn-close" data-bs-dismiss="modal" aria-label="Close" />
          </ModalHeader>
          <ModalBody>
            <form>
          ...
          <div className="modal-footer py-2">
            <button type="button" className="btn btn-primary" data-bs-dismiss="modal">Send
              Message</button>
