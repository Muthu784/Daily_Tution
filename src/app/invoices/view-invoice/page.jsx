        ...
        <Col xs={12}>
          <Card>
              ...
              <Row>
                <Col xs={4}>
                  <div className="mb-4">
                    ...
                    <h6 className="fs-14 text-muted mb-2 lh-base">1055 Station Street Fremont,
                      <br /> CA - 94539
                    </h6>
                ...
                <Col xs={4}>
                  <div className="mb-4">
                    ...
                    <h6 className="fs-14 text-muted mb-2 lh-base">1147 Rohan Drive Suite,
            ...
            <div className="mt-4">
                ...
                <Table className="text-center table-nowrap align-middle mb-0">
                  <thead>
                    <tr className="bg-light bg-opacity-50">
                      <th className="border-0" scope="col" style={{
                      width: 50
                    }}>#</th>
                      <th className="text-start border-0" scope="col">Product Details</th>
                  ...
                  <tbody id="products-list">
                    {invoiceProductData.map((item, idx) => <tr key={idx}>
                          ...
                          <td className="text-start">
                            <div className="d-flex align-items-center gap-2">
                              ...
                              <div>
                                ...
                                <p className="text-muted mb-0">({item.description})
                                </p>
                              </div>
                            </div>
                          </td>
              ...
              <div>
                <Table className="table-nowrap align-middle mb-0 ms-auto" style={{
                width: 335
              }}>
                  <tbody>
                    <tr>
                    ...
                    <tr>
                      <td className="fw-medium">Shipping <small className="text-muted">(Free)</small>
                      </td>
                      <td className="text-end">-</td>
                    </tr>
                    <tr>
                      <td className="fw-medium">Discount <small className="text-muted">(10%)</small>
                      </td>
                      <td className="text-end">-$259.90</td>
                    </tr>
                    <tr>
                      <td className="fw-medium">Tax <small className="text-muted">(5%)</small></td>
            ...
            <CardBody>
              <div className="bg-body p-2 rounded-2 mt-4">
                <p className="mb-0"><span className="fs-12 fw-bold text-uppercase">Note : </span>Payment for
              ...
              <div className="mt-4">
                <p className="mb-2 pb-2"><b>Congratulations on your recent purchase!</b> It has been our
                  pleasure to serve you, and we hope we see you again soon.</p>
                <div className="d-inline-block">
                  <img src={signature} alt="signature" height={32} />
          ...
          <div className="d-print-none mb-5">
            <div className="d-flex justify-content-center gap-2">
              <PrintButton />
              <a href="" className="btn btn-secondary"><IconifyIcon icon='tabler:send' className="me-1" />
                Send</a>
              <a href="" className="btn btn-info"><IconifyIcon icon='tabler:download' className="me-1" />
                Download</a>
            </div>
          </div>
        </Col>
