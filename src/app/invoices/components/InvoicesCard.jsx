  ...
  return <>
      ...
      <Card>
        <CardHeader className="border-bottom justify-content-between d-flex flex-wrap align-items-center gap-2">
          ...
          <Link to="/invoices/create-invoice" className="btn btn-primary"><IconifyIcon icon='tabler:plus' className="me-1" />Add Invoice</Link>
        </CardHeader>
          ...
          <Table className="table-hover text-nowrap mb-0">
            ...
            <tbody>
              {invoiceData?.map((item, idx) => <tr key={idx}>
                    ...
                    <td><span className="fw-semibold"><Link to="/invoices/view-invoice" className="text-reset">#WA-202{idx + 1}</Link></span></td>
