...
const CreateInvoicePage = () => {
  return <>
      <PageBreadcrumb title='Create Invoice' />
      <Row>
        <Col xs={12}>
            ...
            <Form>
              <CardBody>
                <div className="d-flex align-items-start justify-content-between mb-4">
                  <div className="overflow-hidden position-relative border rounded d-flex align-items-center justify-content-start px-2" style={{
                  height: 60,
                  width: 260
                }}>
                ...
                <div className="mt-4">
                  ...
                  <div>
                    <Table className="table-sm table-borderless table-nowrap align-middle mb-0 ms-auto" style={{
                    width: 300
                  }}>
                      <tbody>
                        <tr>
